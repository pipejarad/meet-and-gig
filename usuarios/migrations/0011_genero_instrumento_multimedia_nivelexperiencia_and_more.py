...
#
# Parche (05-06-2026): Genero e Instrumento nacen managed=False, por lo que
# Django no crea sus tablas — pero modelos posteriores de ESTA MISMA migración
# les apuntan con ForeignKey. SQLite lo toleraba; PostgreSQL exige que la
# tabla exista al crear la FK. El RunPython de abajo crea ambas tablas de
# forma portable antes de los modelos que las referencian. (La migración 0019
# conserva un guard idéntico, idempotente, para BDs que ya pasaron por aquí.)
...
def crear_tablas_catalogos_no_gestionados(apps, schema_editor):
    """Crear físicamente las tablas de Genero/Instrumento (managed=False)."""
    tablas_existentes = schema_editor.connection.introspection.table_names()
    for nombre_modelo in ('Genero', 'Instrumento'):
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        # Crear las tablas managed=False ANTES de los modelos que les apuntan
        # con FK (ver nota al inicio del archivo). Sin reverso: las tablas
        # quedan, igual que en el comportamiento histórico.
        migrations.RunPython(
            crear_tablas_catalogos_no_gestionados, migrations.RunPython.noop
        ),
        migrations.CreateModel(
            name='Multimedia',
            fields=[
